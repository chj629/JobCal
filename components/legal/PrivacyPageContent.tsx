...
// app/privacy/page.tsx(ja)와 app/ko/privacy/page.tsx(ko)가 공유하는 실제 페이지 본문 —
    ...
    >
      ...
      <LegalSection title={t("legal.privacy.section9Title")}>
        ...
        <p>
          ...
          <Link href={toPublicPageHref(locale, "/tokushoho")} className="underline hover:text-neutral-900">
