...
// app/terms/page.tsx(ja)와 app/ko/terms/page.tsx(ko)가 공유하는 실제 페이지 본문 —
      ...
      <LegalSection title={t("legal.terms.section5Title")}>
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            <Link href={toPublicPageHref(locale, "/refund-policy")} className="underline hover:text-neutral-900">
