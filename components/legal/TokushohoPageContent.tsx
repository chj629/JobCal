...
// app/tokushoho/page.tsx(ja)와 app/ko/tokushoho/page.tsx(ko)가 공유하는 실제 페이지
// 본문 — 두 라우트 모두 이 컴포넌트를 그대로 렌더링하고, 감싸는 LocaleProvider(locked)의
...
export default function TokushohoPageContent() {
  const t = useT();
