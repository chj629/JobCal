// GoogleIcon.tsx와 동일한 목적: Apple 로고 마크(브랜드 마크)를 임의로 재해석하지 않고
// 표준 Apple 로고 SVG path를 그대로 사용한다. /login부터 공용 컴포넌트로 쓰고,
// signup은 기존 GoogleIcon과 동일하게 이번 범위에서 로컬 버전을 둔다.
